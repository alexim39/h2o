...
export class VideosComponent {
  ...
  videos: VideoItem[] = [
    ...
    // Curated YouTube — hydrogen water science (embedded, no redirect)
    { id:'yt-benefits-1', youtubeId:'FZtaexSmYkQ', title:'Hydrogen Water Benefits Explained — Dr. Paul Barattiero', category:'learn', badge:'Learn • YouTube • Benefits', desc:'Why hydrogen water is gaining worldwide attention — antioxidant, anti-inflammatory, mitochondrial support. Educational, not medical advice.' },
    { id:'yt-101', youtubeId:'IvNNls6aJLk', title:'Hydrogen Water 101 — Introduction to Health Benefits', category:'learn', badge:'Learn • YouTube • 101', desc:'Comprehensive intro: what H₂ water is, how SPE/PEM works, and the 1000+ studies on oxidative stress.' },
    { id:'yt-gundry', youtubeId:'GiS5TsLRNEw', title:'The 4 Mistakes We Make When Drinking Water — Dr. Gundry', category:'learn', badge:'Learn • YouTube • Hydration', desc:'Common hydration mistakes and why hydrogen-rich water is discussed for longevity — from Dr. Gundry’s channel.' },
    { id:'yt-water-truth', youtubeId:'3dd7uqS4FCY', title:'The Truth About The Water You’re Drinking — Dr. Gundry', category:'learn', badge:'Learn • YouTube • Science', desc:'Contaminants, filtration, and where hydrogen water fits in a modern hydration ritual.' },
  ];
