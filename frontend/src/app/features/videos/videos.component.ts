...
export class VideosComponent {
  ...
  videos: VideoItem[] = [
    ...
    { id:'yt-BJnsBks03MY', youtubeId:'BJnsBks03MY', title:'Hydrogen Facts That Will Blow Your Mind!', category:'learn', badge:'Learn • YouTube • Q&A', desc:'Molecular Hydrogen: Safe, Natural, and Science-Backed Wellness Tool Is molecular hydrogen safe? Absolutely. With a spotless safety record and no known side effects, hydrogen is naturally produced in the body and can be delivered through water, inhalation, topical devices, or baths.' },
