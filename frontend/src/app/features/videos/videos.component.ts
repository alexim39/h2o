...
export class VideosComponent {
  ...
  videos: VideoItem[] = [
    ...
    // Curated YouTube — your 7 links (embedded, no redirect) + essentials
    { id:'yt-93Pcv9ry7L8', youtubeId:'93Pcv9ry7L8', title:'Hydrogen Water Bottles: Your Questions Answered.', category:'learn', badge:'Learn • YouTube • Q&A', desc:'10 Years Younger — answers the top questions on hydrogen bottles: how they work, ppb, and daily use. Educational.' },
    { id:'yt-RLLAgmPSE_4', youtubeId:'RLLAgmPSE_4', title:'Why I Changed My Mind About Hydrogen Water (with Tyler LeBaron)', category:'learn', badge:'Learn • YouTube • Expert', desc:'Paul Saladino MD with hydrogen scientist Tyler LeBaron — why he changed his mind. Deep science, balanced view.' },
    { id:'yt-ciyvUm1iz8w', youtubeId:'ciyvUm1iz8w', title:'Benefits of Hydrogen Water to Fight Oxidative Stress — Dr. Paul Barattiero', category:'learn', badge:'Learn • YouTube • Science', desc:'Ayık Kafa — Dr. Paul Barattiero on how H₂ fights oxidative stress and inflammation. Educational.' },
    { id:'yt-_LeWBAY-2rQ', youtubeId:'_LeWBAY-2rQ', title:'The 4 Key Benefits Of Hydrogen Water', category:'learn', badge:'Learn • YouTube • Benefits', desc:'HBOT USA — the 4 key benefits distilled: antioxidant, anti-inflammatory, recovery, clarity.' },
    { id:'yt-hdoEaJ8xok0', youtubeId:'hdoEaJ8xok0', title:'I Investigated Drinking Hydrogen Water', category:'learn', badge:'Learn • YouTube • Investigated', desc:'pigmie (Focused Lucas) — an honest, independent investigation into drinking hydrogen water.' },
    { id:'yt-mimGdwc-w0g', youtubeId:'mimGdwc-w0g', title:'What Makes Hydrogen Rich Water So Special? | TUH #144', category:'learn', badge:'Learn • YouTube • Podcast', desc:'Ultimate Human with Gary Brecka — what makes H₂-rich water special for health. Podcast deep dive.' },
    { id:'yt-0JxkAX4xrMM', youtubeId:'0JxkAX4xrMM', title:'Is Hydrogen Water Good for Kidney Disease? Doctor Review', category:'learn', badge:'Learn • YouTube • Kidney', desc:'Kidney Wellness with Dr. Bismah — honest doctor review on H₂ and kidney health. Educational, not medical advice.' },
  ];
